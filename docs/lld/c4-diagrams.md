...
|------|--------|------------|
| **Public Internet** | Grey | User, DNS Route53 (`go.buffden.com`) |
...
Internet
  │
  │ HTTPS — go.buffden.com / tinyurl.buffden.com
  ▼
...
|-----------|-------------|-------|
| Internet → CloudFront Distribution (API) | `HTTPS — go.buffden.com` | Blue solid |
...
| Internet → CloudFront Distribution (SPA) | `HTTPS — tinyurl.buffden.com` | Blue solid |
