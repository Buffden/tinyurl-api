...
- [ ] Deployment to `go.buffden.com` (API + short URL redirects) and `tinyurl.buffden.com` (Angular SPA)
...
- System is live at `go.buffden.com` (API + short URL redirects) and `tinyurl.buffden.com` (Angular SPA).
